...
import CarDriveCanvas from './3d/CarDriveCanvas';
import './Home.css';
...
const Home = () => {
  ...
  return (
    <>
      ...
      {/* 3D Car Driving Playground Section */}
      <section id="3d-drive" className="drive-section reveal-on-scroll">
        <div className="drive-section-header">
          <span className="drive-badge-tag">⚡ NEXT-GEN PORTFOLIO EXPERIENCE</span>
          <h2 className="drive-section-title">
            🏎️ <span className="highlight">3D Interactive Arena</span>
          </h2>
          <p className="drive-section-subtitle">
            Drive the 3D sports car or click top navigation pills (About, Skills, Projects, Contact) to glide directly to sections!
          </p>
        </div>
        <CarDriveCanvas onNavigateSection={handleNavigateSection} />
      </section>
